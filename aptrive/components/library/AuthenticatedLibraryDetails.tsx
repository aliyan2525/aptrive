  ...
  return (
    <main className="app-content min-w-0 bg-[linear-gradient(180deg,#fbfdff,#f4f7ff)] px-3 py-5 text-fg sm:px-6 sm:py-8 lg:px-9">
      <div className="mx-auto max-w-[96rem]">
        <Link href="/materials" className="inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-muted hover:text-violet-700">← All resources</Link>
  ...
  return (
    <main className="app-content min-w-0 bg-[linear-gradient(180deg,#fbfdff,#f4f7ff)] px-3 py-5 text-fg sm:px-6 sm:py-8 lg:px-9">
      <div className="mx-auto max-w-4xl">
        <Link href={`/materials/${resource.categorySlug}`} className="inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-muted hover:text-violet-700">← Back to {categoryName}</Link>
