  ...
  return (
    <main className="app-content min-w-0 bg-[linear-gradient(180deg,#fbfdff,#f4f7ff)] px-3 py-5 text-fg sm:px-6 sm:py-8 lg:px-9">
      <div className="mx-auto max-w-4xl">
        ...
        <article className="mt-5 rounded-[1.5rem] border border-white/90 bg-white/85 p-5 shadow-[0_16px_46px_rgba(33,45,92,0.08)] sm:p-8">
...
function Stat({ label, value }: { label: string; value: string }) {
  return <div className="min-w-0 rounded-xl border border-line bg-white/70 p-3"><p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-2">{label}</p><p className="mt-1 truncate text-sm font-semibold text-fg">{value}</p></div>;
}
