...
export default function LibraryExperience() {
  ...
  return (
    <main className="library-reference relative overflow-hidden bg-[radial-gradient(circle_at_72%_0%,rgba(191,246,239,0.42),transparent_30rem),linear-gradient(180deg,#ffffff_0%,#f7faff_54%,#eef3ff_100%)]">
      ...
      <section className="container-aptrive relative z-10 pb-10 pt-24 md:pb-16 md:pt-32">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(22rem,0.95fr)] lg:items-end">
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }} className="library-featured premium-shell relative overflow-hidden rounded-[1.75rem] border border-white/80 bg-white/76 p-6 shadow-[0_24px_70px_rgba(56,42,122,0.10)] backdrop-blur-xl md:p-7">
      ...
      <section className="container-aptrive relative z-10 pb-10">
        ...
        <div className="library-subject-grid grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <section className="container-aptrive relative z-10 py-12 md:py-20">
        <div className="library-index premium-shell rounded-[1.75rem] border border-white/80 bg-white/72 p-5 shadow-[0_22px_70px_rgba(46,39,97,.08)] backdrop-blur-xl md:p-7">
