  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-0 hidden lg:block overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-[10%] rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl shadow-2xl shadow-blue-500/10"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-display font-bold text-white">45,000+</div>
            <div className="text-[10px] uppercase tracking-wider text-white/50">Questions Solved</div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 right-[10%] rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl shadow-2xl shadow-teal-500/10"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-display font-bold text-white">12,500+</div>
            <div className="text-[10px] uppercase tracking-wider text-white/50">Admitted Students</div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-[20%] right-[20%] text-6xl font-serif text-white/10"
      >
        ∑
      </motion.div>
      <motion.div
        ...
        className="absolute bottom-[30%] left-[20%] text-6xl font-serif text-white/10"
      >
        π
      </motion.div>
      <motion.div
        ...
        className="absolute top-[40%] right-[30%] text-5xl font-serif text-white/10"
      >
        ∫
      </motion.div>
    </div>
