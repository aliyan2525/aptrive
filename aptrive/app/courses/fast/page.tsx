...
const uni = universities.find((u) => u.id === "fast")!;

export const metadata: Metadata = {
  title: "FAST-NUCES Entry Test Preparation — Aptrive",
  description:
    "Full FAST-NUCES (NU / NAT) entry test preparation: quantitative, analytical, and verbal reasoning practice with diagnostics, analytics, and timed mock exams.",
};
...
const faqs = [
  {
    ...
    a: "Students preparing for FAST-NUCES's undergraduate entry test who want a structured, analytics-driven approach rather than generic practice books.",
  },
  {
    q: "Does this cover the Computer Science-specific sections?",
    a: "The current track focuses on the quantitative, analytical, and verbal reasoning sections common across FAST-NUCES programs. Program-specific subject sections are being added as Aptrive expands.",
  },
  {
...
export default function FastPage() {
  return (
    <>
      <CourseSchema
        name="FAST-NUCES Entry Test Preparation"
        description="Quantitative, analytical, and verbal reasoning preparation for the FAST-NUCES entry test, with diagnostics, adaptive practice, analytics, and timed mock exams."
      />
      <section className="container-aptrive py-16 md:py-24">
        <div className="grid gap-12 md:grid-cols-2 md:items-start">
          <div>
            <UniversityLogo university="fast" displayName="FAST-NUCES" size={48} className="mb-4" />
            <div className="eyebrow">FAST-NUCES · Computer Science & Engineering</div>
            <h1 className="font-display mt-3 text-4xl font-semibold tracking-tight text-fg md:text-5xl">
              FAST-NUCES Entry Test Preparation
            </h1>
            <p className="mt-5 max-w-md text-sm leading-relaxed text-muted">
              A complete preparation track for FAST-NUCES's entry test, built
      ...
      <section className="container-aptrive py-16 md:py-24">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted">
          ...
          estimated FAST-NUCES aggregate.
        </p>
        <Link
        ...
        >
          Calculate your FAST-NUCES aggregate →
        </Link>
      </section>
      ...
      <section className="container-aptrive pb-16 md:pb-24">
        <div className="rounded-md border border-line bg-panel p-6 md:p-8">
          ...
          <div className="mt-4 flex flex-wrap gap-x-6 gap-y-2">
            ...
            <Link
              href="/library/english"
              className="text-sm font-medium text-teal hover:underline"
            >
              Go to the English library →
            </Link>
          </div>
        </div>
      </section>
